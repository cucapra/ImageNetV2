...
ga = GeneticAlgorithm(alldata,population_size=population_size,generations=15)#50
def qtable_ij(ij):
...
def selection(population):
    members = random.sample(population, int(population_size/5) )#/5
    members.sort(
